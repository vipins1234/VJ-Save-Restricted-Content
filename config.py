...
API_ID = int(os.environ.get("API_ID", "27350338"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "69a3d8741b0efd6c60b89b8c1b5e5342")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "7203328405"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://vipintech:fsrgdhedgh@cluster0.hwptflg.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
